...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *TorrentChain.Lambda*):

Restore dependencies
```
    cd "TorrentChain.Lambda"
    dotnet restore
```

Execute unit tests
```
    cd "TorrentChain.Lambda/test/TorrentChain.Lambda.Tests"
    dotnet test
```

Deploy application
```
    cd "TorrentChain.Lambda/src/TorrentChain.Lambda"
